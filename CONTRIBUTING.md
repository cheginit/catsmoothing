...
> [Documentation](https://cheginit.github.io/catsmoothing).

Before you ask a question, it is best to search for existing
[Issues](https://github.com/cheginit/catsmoothing/issues) that might help you. In case
...
- Determine if your bug is really a bug and not an error on your side e.g. using
    ...
    [documentation](https://cheginit.github.io/catsmoothing). If you are looking for
...
- Open an [Issue](https://github.com/cheginit/catsmoothing/issues/new). (Since we can't
...
This section guides you through submitting an enhancement suggestion for CatSmoothing,
...
- Make sure that you are using the latest version.
- Read the [documentation](https://cheginit.github.io/catsmoothing) carefully and find
    out if the functionality is already covered, maybe by an individual configuration.
- Perform a [search](https://github.com/cheginit/catsmoothing/issues) to see if the
...
[GitHub issues](https://github.com/cheginit/catsmoothing/issues).
...
- **Describe the current behavior** and **explain which behavior you expected to see
    ...
    for you.
- **Explain why this enhancement would be useful** to most CatSmoothing users. You may
...
1. Add tests for your changes either in `tests/test_catsmoothing.py` file or create a
    new file in the `tests` directory with the name `test_<module_name>.py`.
1. Run `pixi r -e test310` and `pixi r -e test314` to run the tests.
...
CatSmoothing could always use more documentation, whether as part of the official
CatSmoothing docs, in docstrings, or even on the web in blog posts, articles, and such.
